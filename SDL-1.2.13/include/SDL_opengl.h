...
/*S60 installer change - start*/
#if defined(__WIN32__) && !defined(__SYMBIAN32__) //GL_ES
/*S60 installer change - end*/
...
/*S60 installer change - start*/
#elif defined(__SYMBIAN32__) //GL_ES
#include <SDL_gliop.h>
#include <gles/gl.h>
/*S60 installer change - end*/
#else
...
/*S60 installer change - start*/
#if defined(_WIN32) && !defined(APIENTRY) && !defined(__CYGWIN__) && !defined(__SCITECH_SNAP__) && !defined(__SYMBIAN32__) //GL_ES
/*S60 installer change - end*/
