...
#define KLeftButtonCode1 EStdDeviceKeyAction 
#define KLeftButtonCode2 EStdDeviceKeySoftkey1
#define KRightButtonCode EStdDeviceKeySoftkey2
#else
#define KLeftButtonCode1 EStdKeyDevice0
#define KLeftButtonCode2 EStdKeyDevice3
#define KRightButtonCode EStdKeyDevice1
#endif
