...
int EPOC_VideoInit(_THIS, SDL_PixelFormat *vformat)
{
	...
	Private->iEikEnv=CEikonEnv::Static();
    ...
    vformat->BitsPerPixel       = GetBpp(displayMode) ;
	...
	Private->SDL_modelist[5]->w = 256; Private->SDL_modelist[5]->h = 240;
	Private->SDL_modelist[6]->w = 	Private->EPOC_ScreenSize.iWidth ; Private->SDL_modelist[6]->h = 	Private->EPOC_ScreenSize.iHeight;
	Private->SDL_modelist[7]->w = 	Private->EPOC_ScreenSize.iHeight ; Private->SDL_modelist[7]->h = 	Private->EPOC_ScreenSize.iWidth ;
	Private->SDL_modelist[8] = NULL;
