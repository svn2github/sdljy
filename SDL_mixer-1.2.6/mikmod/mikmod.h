...
typedef signed char     SBYTE;      /* 1 byte, signed */
typedef unsigned char   UBYTE;      /* 1 byte, unsigned */
typedef signed short int   SWORD;      /* 2 bytes, signed */
typedef unsigned short int  UWORD;      /* 2 bytes, unsigned */
typedef signed long int    SLONG;      /* 4 bytes, signed */
typedef unsigned long int  ULONG;      /* 4 bytes, unsigned */
typedef int             BOOL;       /* 0=false, <>0 true */
#endif
