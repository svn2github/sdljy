...
CONFIG.DataPath="e:\\data\\jy\\data\\";
CONFIG.PicturePath="e:\\data\\jy\\pic\\";
CONFIG.SoundPath="e:\\data\\jy\\sound\\";
CONFIG.ScriptPath="e:\\data\\jy\\script\\";
CONFIG.OldEventPath=CONFIG.ScriptPath .. "oldevent\\";
CONFIG.NewEventPath=CONFIG.ScriptPath .. "newevent\\";
CONFIG.ScriptLuaPath="?.lua;e:\data\jy\script\?.lua;e:/data/jy/script/?.lua";        --用lua规则写的路径
...
CONFIG.FontName="e:\\data\\jy\\font\\simsun.ttc";
